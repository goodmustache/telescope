...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "6841af5189cd8fce7191a72f3079dbb9af9fda54";
const resourcesToCache = ["https://raw.githubusercontent.com/maxence-charriere/go-app/master/docs/web/icon.png","/telescope/web/app.wasm","/telescope/wasm_exec.js","/telescope/manifest.webmanifest","/telescope/app.js","/telescope/app.css","/telescope"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 6841af5189cd8fce7191a72f3079dbb9af9fda54");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 6841af5189cd8fce7191a72f3079dbb9af9fda54 is activated");
  } catch (error) {
