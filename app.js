...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/telescope","GOAPP_STATIC_RESOURCES_URL":"/telescope/web","GOAPP_VERSION":"6841af5189cd8fce7191a72f3079dbb9af9fda54"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/telescope/web/app.wasm", showProgress),
      go.importObject
    );
